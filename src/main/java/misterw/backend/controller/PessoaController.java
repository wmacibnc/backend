package misterw.backend.controller;
...
import misterw.backend.service.PessoaService;
...
public class PessoaController {
	...
	public @ResponseBody Pessoa obter(@PathVariable(value = "numeroPessoa") Long numeroPessoa) throws PocException {
	...
	public @ResponseBody List<Pessoa> consultar() throws PocException {
		return service.consultar();
	}
	
	@RequestMapping(method = {RequestMethod.POST, RequestMethod.PUT}, value = "/salvar", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<Pessoa> salvar(@RequestBody Pessoa pessoa) throws PocException {
	...
	public ResponseEntity<Void> excluir(@RequestParam(value = "numeroPessoa") Long numeroPessoa) throws PocException {
